...
else $lista_cliente = $bll->SelectNome($busca);
            ...
            <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
                ...
                <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                    <div class="flex md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                        ...
                        <h1 class="flex justify-center items-center text-white text-xl font-bold">Lista de clientes</h1>
                            <form action="../cliente/lista.php" method="GET" class=" m-auto justify-center items-center">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr class="border-b dark:border-gray-700">
                                        <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white"><?php echo $cliente->getId(); ?></th>
                                        <td class="px-4 py-3"><?php echo $cliente->getNome(); ?></td>
                                        <td class="px-4 py-3"><?php echo $cliente->getAniversarioF(); ?></td>
                                        <td class="px-4 py-3"><?php echo $cliente->getCpf(); ?></td>
                                        <td class="px-4 py-3"><?php echo $cliente->getTelefone(); ?></td>
                                        ...
                                        <td class="px-6 py-4 gap-8">
                                            <a href="#" class="font-medium text-red-600 dark:text-red-500 hover:underline" onclick="JavaScript: remover(<?php echo $cliente->getId(); ?>);">
                                                Remover
                                            </a>
                                        </td>
                                    </tr>
