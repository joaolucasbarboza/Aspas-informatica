            ...
            <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
                ...
                <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                    <div class="flex md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                        ...
                        <h1 class="flex justify-center items-center text-white text-xl font-bold">Lista de fornecedores</h1>
                            <form action="../fornecedor/lista.php" method="GET" id='frmBuscaFuncionario' class=" m-auto justify-center items-center">
                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                <tr>
                                    ...
                                    <th scope="col" class="px-4 py-3">Razão Social</th>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr class="border-b dark:border-gray-700">
                                        <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white"><?php echo $fornecedor->getId(); ?></th>
                                        <td class="px-4 py-3"><?php echo $fornecedor->getRazaoSocial(); ?></td>
                                        <td class="px-4 py-3"><?php echo $fornecedor->getCnpj(); ?></td>
                                        <td class="px-4 py-3"><?php echo $fornecedor->getEmail(); ?></td>
                                        ...
                                        <td class="px-6 py-4 gap-8">
                                            <a href="#" class="font-medium text-red-600 dark:text-red-500 hover:underline" onclick="JavaScript: remover(<?php echo $fornecedor->getId(); ?>);">
                                                Remover
                                            </a>
                                        </td>
                                    </tr>
